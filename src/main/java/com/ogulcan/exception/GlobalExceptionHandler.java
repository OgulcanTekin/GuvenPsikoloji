...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleException(Exception exception){
        ...
        return ResponseEntity.badRequest().body("Uygulamada beklenmeyen bir hata oluştu...: "
                + exception.getMessage());
    }

    @ResponseBody
    @ExceptionHandler(RandevuManagerException.class)
    public ResponseEntity<ErrorMessage> handleSatisManagerExcetion(RandevuManagerException exception){
